...
export default function About(props) {
    ...
    return (
        <div className="container" style={myStyle}>
            ...
            <p>
                Welcome to our multi-utility website — a single platform offering multiple helpful tools designed to make your daily tasks easier and more efficient.
                Below is a detailed overview of the four key apps integrated into our platform:
            </p>
            ...
            <div className="accordion my-2" id="accordionExample">
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button" type="button" style={myStyle} data-bs-toggle="collapse" data-bs-target="#proReact" aria-expanded="true" aria-controls="proReact">
                    ...
                    <div id="proReact" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            <strong>ProReact</strong> is a powerful text utility tool that allows users to effortlessly manage text with the following features:
                            <ul>
                                ...
                                <li>Estimate the <strong>reading time</strong></li>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" style={myStyle} data-bs-toggle="collapse" data-bs-target="#chatNest" aria-expanded="false" aria-controls="chatNest">
                            🤖 ChatNest — AI Chatbot
                        </button>
                    </h2>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" style={myStyle} data-bs-toggle="collapse" data-bs-target="#toDoManager" aria-expanded="false" aria-controls="toDoManager">
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" style={myStyle} data-bs-toggle="collapse" data-bs-target="#weatherApp" aria-expanded="false" aria-controls="weatherApp">
                    ...
                    <div id="weatherApp" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            ...
                            <ul>
                                ...
                                <li>Example:
                                    <div style={{ backgroundColor: darkMode ? '#1c1c1c' : '#e0e0e0', padding: '10px', borderRadius: '5px', marginTop: '10px' }}>
                                        📍 Location: <strong>Goa</strong><br />
                                        🌡️ 24°C — Scattered Clouds<br />
                                        🌡️ Feels like: 24°C<br />
                                        💧 Humidity: 65%<br />
